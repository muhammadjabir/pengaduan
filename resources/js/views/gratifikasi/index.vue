<template>
    <v-app>
        ...
        <v-container v-if="!loading">
            <v-btn small color="teal darken-2" class="white--text" tile>Gratifikasi Online</v-btn>
            <v-card
            class="border-edit"
            tile
            >
                <v-card-text class="text-center">
                    ...
                    <v-simple-table>
                        ...
                        <thead>
                            ...
                            <th class="text-left">Nama Pemberi</th>
                        ...
                        <tbody>
                            <tr v-for="item in data" :key="item.id">
                                ...
                                <td class="text-left">{{item.tgl_terima}}</td>
                                <td class="text-left">{{item.nama_pemberi}}</td>
                                <td class="text-left">
