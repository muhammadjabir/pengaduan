    ...
    <v-app>
        <v-row>
            <v-col
                ...
                >
                <v-container>
                    <v-btn small color="teal darken-2" class="white--text" tile>Data Pengaduan Korupsi</v-btn>
                    <v-card
                    class="border-edit"
                    tile
                    >
                        ...
                        <v-card-text>
                            <v-container>
                                ...
                                <br>
                                <p>Waktu kejadian : {{ kapan }}</p>
                                <p>Lokasi kejadian : {{ dimana }}</p>
...
import OmjakaMixin from '../../mixins/OmjakaMixin'
export default {
    name: 'omjaka.edit',
